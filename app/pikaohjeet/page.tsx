                        ...
                        return (
                          <div key={s.key} className={classNames("p-8 rounded-[2rem] border transition-all duration-500 shadow-sm", hl?.severity === "danger" ? "bg-rose-50 border-rose-200" : hl?.severity === "warning" ? "bg-amber-50 border-amber-200" : hl?.severity === "info" ? "bg-blue-50 border-blue-200" : "bg-white border-slate-100")}>
                            <div className="flex justify-between items-start mb-4">
                              ...
                              <div className="flex flex-col gap-1.5">{hl?.hints.map((h, i) => <div key={i} className="px-3 py-1 bg-white border border-slate-100 rounded-xl text-[9px] font-black flex items-center gap-2 shadow-sm animate-in slide-in-from-right-2"><AlertTriangle size={12} className="text-amber-500" /> {h}</div>)}</div>
                            </div>
            ...
            <div className="flex-1 overflow-y-auto p-10 custom-scrollbar space-y-10">
               ...
               {editTab === "content" && (
                <div className="space-y-6 animate-in slide-in-from-bottom-4">
                  ...
                  {/* ВЕРНУЛ КНОПКУ ДОБАВЛЕНИЯ СЕКЦИИ */}
               ...
               {editTab === "rules" && (
                 <div className="space-y-6 animate-in slide-in-from-bottom-4">
                   {Object.values(draft.rules.reduce((acc: any, r) => {
                     ...
                     <div key={gIdx} className="p-8 bg-blue-50/30 rounded-[2.5rem] border border-blue-100 space-y-4 relative shadow-sm">
