...
export default function AdminUsersPage() {
  ...
  async function createUser() {
    ...
    try {
      ...
      setNewUser({ name: "", email: "", initialCredential: "", mustChangePassword: true });
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <section className="bg-white border border-slate-200 rounded-[2rem] p-6 shadow-sm space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          />
          <input
            value={newUser.initialCredential}
            onChange={(event) => setNewUser({ ...newUser, initialCredential: event.target.value })}
          ...
          <button
            onClick={createUser}
            disabled={saving || !newUser.email || newUser.initialCredential.length < 8}
                        ...
                        {isEditing ? (
                          <div className="space-y-2">
                            ...
                            <input
                              ...
                              placeholder="Uusi salasana (jätä tyhjäksi, jos et vaihda)"
                              type="password"
                              className="w-full px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-sm"
                            />
                            <input
