...
const copy = {
    ...
    subtitle: 'Hallitse PCA- ja PEDS-laskureiden omia lääkekirjastoja. Laskureiden laskentalogiikkaa ei muuteta tällä sivulla.',
    refresh: 'Päivitä',
    ...
    pedsIndicationsTitle: 'PEDS-indikaatiot / sairaudet',
    ...
    savePedsDrug: 'Tallenna PEDS-lääke',
    ...
    savedDrugsTitle: 'Tallennetut PEDS-lääkkeet',
    showing: 'Näytetään',
  ...
  ru: {
    ...
    subtitle: 'Управление собственными библиотеками препаратов для PCA- и PEDS-калькуляторов. Логика расчётов на этой странице не меняется.',
    refresh: 'Обновить',
    ...
    pedsIndicationsTitle: 'PEDS-показания / заболевания',
    ...
    addDrugTitle: 'Добавить PEDS-препарат',
    ...
    savePedsDrug: 'Сохранить PEDS-препарат',
    ...
    savedDrugsTitle: 'Сохранённые PEDS-препараты',
    showing: 'Показано',
  ...
  en: {
    ...
    subtitle: 'Manage your own drug libraries for PCA and PEDS calculators. Calculator logic is not changed on this page.',
    refresh: 'Refresh',
    ...
    pedsIndicationsTitle: 'PEDS indications / diseases',
    ...
    savedDrugsTitle: 'Saved PEDS drugs',
    showing: 'Showing',
