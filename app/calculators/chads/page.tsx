...
import { Check, Copy, Heart, MessageSquareShare } from "lucide-react";
...
export default function ChadsCalculatorPage({ embedded = false, onDiscussResult }: { embedded?: boolean; onDiscussResult?: (content: string) => void }) {
  ...
  return (
    <div className={embedded ? "p-4 text-slate-900" : "max-w-[1100px] mx-auto space-y-5 pb-10 text-slate-900 p-2 sm:p-4"}>
      {!embedded && <div>
