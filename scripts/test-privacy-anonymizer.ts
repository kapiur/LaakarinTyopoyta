...
const cases: TestCase[] = [
  ...
  {
    name: 'Clinical transform preserves bare dates when only name and phone are present',
    input: `${syntheticName} ${syntheticBareDob} ${syntheticLocalPhone}`,
    mode: 'clinicalTransform',
    expectedFragments: ['[NAME]', syntheticBareDob, '[PHONE]'],
  ...
  {
    name: 'Clinical transform preserves chronology dates in long follow-up summaries',
    input: [
      'Laboratoriot 18.03.2026: Krea 92, eGFR 78, LDL 4.1.',
      'Kontrolli työterveydessä 25.03.2026.',
      'Aiempi polven tekonivelleikkaus tehty 2021, ei akuutteja ongelmia.',
      '',
      'Nykytila',
      '',
      'Ei rintakipua vastaanotolla. Rasituksessa ajoittain hengenahdistusta.',
      'Ei pyörtymistä. Ei alaraajaturvotuksia.',
      '',
      'Suunnitelma',
      '',
      'Aloitetaan verenpaineseuranta kahdeksi viikoksi.',
      'Uusi kontrolli 05.04.2026.',
      'Tarvittaessa sydänlääkärin arvio myöhemmin.',
    ].join('\n'),
    mode: 'clinicalTransform',
    expectedFragments: ['18.03.2026', '25.03.2026', '2021', '05.04.2026'],
    forbiddenFragments: ['[DATE]'],
  },
];
