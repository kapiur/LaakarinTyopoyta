...
const text: Record<string, Replacements> = {
  ...
  ru: {
    ...
    "PEDS-laskuri": "Калькулятор дозировок по весу",
    ...
    "Valitse käyttöaihe ja lääke omasta kirjastosta. Arvot täyttyvät automaattisesti, mutta niitä voi muokata käsin myös muuhun kuin lasten annoslaskentaan.": "Выберите показание и препарат из собственной библиотеки. Значения заполняются автоматически, но их можно менять вручную и для расчётов не только у детей.",
    "Lääkekirjastot": "Библиотеки препаратов",
    "Lääke- ja annoskirjastot": "Библиотеки препаратов и дозировок",
    "Päivitä": "Обновить",
  ...
  en: {
    ...
    "PEDS-laskuri": "Weight-based dose calculator",
    ...
    "Lääke- ja annoskirjastot": "Drug and dose libraries",
    "Päivitä": "Refresh",
