  ...
  return (
    <section className="space-y-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="grid grid-cols-3 gap-2 text-xs font-bold uppercase tracking-wide text-slate-500">
          {[t("onboarding.stepWelcome"), t("onboarding.stepContext"), t("onboarding.stepStart")].map((label, index) => (
            <div
              key={label}
